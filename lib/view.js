...
var locreator = function (thees, context, loc, _loc, el) {
    ...
    context[loc + "Wait"] = function (timeout, msg) {
      return thees.drivex.waitForElement(_loc, timeout || 5000, msg);
    }.bind(thees);
    context[loc + "WaitVisible"] = function (timeout, msg) {
      function waitVisibleReturnElement() {
        return thees.driver.wait(function () {
          return thees.drivex.visible(_loc);
        }, timeout || 5000, msg).then(function() {
          return thees.drivex.find(_loc, el);
        });
      }
      var wep = new thees.wd.WebElementPromise(thees.driver, waitVisibleReturnElement());
      return wep;
    }.bind(thees);
