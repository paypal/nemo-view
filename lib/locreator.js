...
module.exports = function locreator(nemo, locatorId, locatorJSON, parentWebElement) {
  ...
  locatorObject[locatorId + 'OptionValue'] = function (optionValue) {
    ...
    return nemo.drivex.find(locatorJSON, parentWebElement).then(function (selectEl) {
  ...
  locatorObject[locatorId + 'GetText'] = function () {
    return nemo.drivex.find(locatorJSON, parentWebElement).then(function (element) {
