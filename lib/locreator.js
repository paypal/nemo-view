...
Locreator.prototype.addStarMethods = function locreator(locatorId, _locator, parentWebElement) {
  ...
  locatorObject[locatorId + 'ValidateText'] = function (ValidateText) {
    return drivex.validateText(locator, parentWebElement,ValidateText) ;
  };
  locatorObject[locatorId + 'ValidateAttributeValue'] = function (attribute,validateText) {
    return drivex.validateAttributeValue(locator, parentWebElement,attribute,validateText);
  };
