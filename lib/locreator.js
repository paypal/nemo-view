...
Locreator.prototype.addStarMethods = function addStarMethods(locatorId, locatorJSON, parentWebElement) {
  ...
  locatorObject[locatorId + 'Wait'] = function (timeout, msg) {
    return drivex.waitForElementPromise(locator(), timeout || 5000, msg || 'nemo-view: Wait failed for locator [' + locatorId + ']');
  };
  locatorObject[locatorId + 'WaitVisible'] = function (timeout, msg) {
    return drivex.waitForElementVisiblePromise(locator(), timeout || 5000, msg || 'nemo-view: WaitVisible failed for locator [' + locatorId + ']');
  };
