...
Locreator.prototype.addStarMethods = function locreator(locatorId, locatorJSON, parentWebElement) {
  var locatorObject = {};
  var drivex = this.drivex;
  var locreator = this;
...
Locreator.prototype.addGroup = function (locatorId, locatorJSON) {
  ...
  return function () { //give back the nemo.view.viewname.list() function
    return drivex.finds(normalize(nemo, locatorJSON)).then(function (parentWebElements) {
      return nemo.wd.promise.map(parentWebElements, function (parentWebElement) {
        var parentObject = {};
        Object.keys(locatorJSON.Elements).forEach(function (childLocatorId) {
          var childLocatorJSON = locatorJSON.Elements[childLocatorId];
          var starMethods = self.addStarMethods(childLocatorId, childLocatorJSON, parentWebElement);
