...
Locreator.prototype.addGenericMethods = function generics() {
  ...
  nemo.view._optionText = function (locator, optionText, parentElement) {
    return drivex.selectByOptionText(normify(locator), optionText, parentElement);
  };
  nemo.view._optionValue = function (locator, optionValue, parentElement) {
    return drivex.selectByOptionValue(normify(locator), optionValue, parentElement);
  };
