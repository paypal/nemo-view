...
class Locreator {
    ...
    addStarMethods(locatorId, locatorJSON, parentWebElement) {
        ...
        locatorObject[locatorId + 'AssertText'] = locatorObject[locatorId].assertText = (value) => drivex.validateText(locator(), parentWebElement, value);

        locatorObject[locatorId + 'AssertValue'] = locatorObject[locatorId].assertValue = (value) => drivex.validateText(locator(), parentWebElement, value);

        locatorObject[locatorId + 'AssertAttribute'] = locatorObject[locatorId].assertAttribute = (value) => drivex.validateText(locator(), parentWebElement, value);

        locatorObject[locatorId + 'AssertCssValue'] = locatorObject[locatorId].assertCssValue = (value) => drivex.validateText(locator(), parentWebElement, value);
        ...
        locatorObject[locatorId].waitFor = (value, timeout) => drivex.waitFor(locator(), timeout || 5, value);
